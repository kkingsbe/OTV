...
void setup() {
  ...
  guidanceManager->setZeroPointPidConfig(0.075, 0.01, 0.4);
  ...
  */
  ...
  guidanceManager->addWaypoint(1.1, 0.6, 6, false, 0, true, 0, 0);
  guidanceManager->addWaypoint(1.1, 1.3, 7, false, 0, true, 1, 0);
  guidanceManager->addWaypoint(1.1, 1.7, 8, false, 0, true, 2, 0);

  guidanceManager->addWaypoint(1.9, 0.6, 11, false, 0, true, 0, 1);
  guidanceManager->addWaypoint(1.9, 1.3, 10, false, 0, true, 1, 1);
  guidanceManager->addWaypoint(1.9, 1.7, 9, false, 0, true, 2, 1);

  //Clear last column
  guidanceManager->addWaypoint(3.0, 0.6, 12);
  guidanceManager->addWaypoint(3.0, 1.0, 13);
  guidanceManager->addWaypoint(3.0, 1.4, 14);

  guidanceManager->addWaypoint(3.0, 1.5, 15);  //Line up with limbo
  guidanceManager->addWaypoint(3.5, 1.5, 16);  //Pass limbo
